...
python ${CODE_DIR}/data/download_files.py \
    ...
    --target-dev=newstest2011.de \
    --source-test=newstest2013.en \
    --target-test=newstest2013.de \
    --outdir=${DATA_DIR}
...
if [ "$BPE" = true ] ; then
    ...
    perl ${CODE_DIR}/data/tokenizer.perl -threads 5 -l 'de' < ${DATA_DIR}/test2011/newstest2011.de > ${DATA_DIR}/newstest2011.de.tok
    perl ${CODE_DIR}/data/tokenizer.perl -threads 5 -l 'en' < ${DATA_DIR}/test2011/newstest2011.en > ${DATA_DIR}/newstest2011.en.tok
    perl ${CODE_DIR}/data/tokenizer.perl -threads 5 -l 'de' < ${DATA_DIR}/test/newstest2013.de > ${DATA_DIR}/newstest2013.de.tok
    perl ${CODE_DIR}/data/tokenizer.perl -threads 5 -l 'en' < ${DATA_DIR}/test/newstest2013.en > ${DATA_DIR}/newstest2013.en.tok
    perl ${CODE_DIR}/data/tokenizer.perl -threads 5 -l 'de' < ${DATA_DIR}/europarl-v7.de-en.de > ${DATA_DIR}/europarl-v7.de-en.de.tok
    perl ${CODE_DIR}/data/tokenizer.perl -threads 5 -l 'en' < ${DATA_DIR}/europarl-v7.de-en.en > ${DATA_DIR}/europarl-v7.de-en.en.tok

    # extract dictionaries
    python ${CODE_DIR}/data/build_dictionary.py ${DATA_DIR}/europarl-v7.de-en.de.tok
    python ${CODE_DIR}/data/build_dictionary.py ${DATA_DIR}/europarl-v7.de-en.en.tok

    # shuffle traning data
    python ${CODE_DIR}/data/shuffle.py ${DATA_DIR}/europarl-v7.de-en.en.tok ${DATA_DIR}/europarl-v7.de-en.de.tok 
fi
